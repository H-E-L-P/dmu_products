; $Id: //depot/Release/ENVI53_IDL85/idl/idldir/lib/hist_2d.pro#1 $
;
; Copyright (c) 1992-2015, Exelis Visual Information Solutions, Inc. All
...
;               size is set to 1.
;
;       Note: The data type of BIN1, BIN2, MAX1, MAX2, MIN1, MIN2
;       should match the data type of the V1 and V2 arguments.
;       Since these keywords are converted to the data type of V1 and V2,
;       specifying mismatched data types may produce undesired results.
;
; OUTPUTS:
