; $Id: //depot/Release/IDL_81/idl/idldir/lib/curvefit.pro#1 $
;
; Copyright (c) 1982-2011, ITT Visual Information Solutions. All
...
;      CT, ITTVIS, Dec 2010: CR43657: Fix "alpha" computation when FITA is used
;
;-
...
;            Evaluate function and estimate partial derivatives
          ...
          alpha = TRANSPOSE(pder[*,iparam]) # $
            (Weights # (FLTARR(nparam)+1)*pder[*,iparam])
