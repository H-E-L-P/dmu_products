...
module load stilts
stilts ifmt=fits in=@cat_files out=dmu26_XID+PACS_AKARI-NEP_cat.fits
```
 
#### Computation 
 Details on computational cost of fittingAKARI-NEP:




### Final data products
  Final stage requires examination and validation of catalogues using [XID+PACS_AKARI-NEP_final_processing.ipynb](XID+PACS_AKARI-NEP_final_processing.ipynb).
