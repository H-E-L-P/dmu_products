...
module load stilts
stilts ifmt=fits in=@cat_files out=dmu26_XID+PACS_GAMA-15_cat.fits
```
...
### Final data products
  Final stage requires examination and validation of catalogues using [XID+PACS_GAMA-15_final_processing.ipynb](XID+PACS_GAMA-15_final_processing.ipynb).
