...
#for b in bands:
#	hdulists.append(fits.open(output_folder+'dmu26_XID+SPIRE_'+b+'_Lockman-SWIRE_Bayes_Pval_20180118.fits'))
...
for i in range(0,len(priors)):
	hdulists[i].writeto(output_folder+'dmu26_XID+SPIRE_'+bands[i]+'_Lockman-SWIRE_Bayes_Pval_20180220.fits',clobber=True)
