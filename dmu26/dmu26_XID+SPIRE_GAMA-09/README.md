...
stilts tcat ifmt=fits in=@cat_files out=dmu26_XID+SPIRE_GAMA-09_cat.fits
```
...
### Final data products
  Final stage requires examination and validation of catalogues using [XID+SPIRE_GAMA-09_final_processing.ipynb](XID+SPIRE_GAMA-09_final_processing.ipynb).
