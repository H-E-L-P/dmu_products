...
stilts tcat ifmt=fits in=@cat_files out=dmu26_XID+SPIRE_GAMA-15_cat.fits
```
 
#### Computation 
 Details on computational cost of fitting GAMA-15:
...
### Final data products
  Final stage requires examination and validation of catalogues using [XID+SPIRE_GAMA-15_final_processing.ipynb](XID+SPIRE_GAMA-15_final_processing.ipynb).
