...
stilts tcat ifmt=fits in=@cat_files out=dmu26_XID+SPIRE_CDFS-SWIRE_cat.fits
```
...
======================================================================================================================
pdh21       3551587  11497108.256     13523.216  11624628.003        8685424.722            169.894              0.000
``` 
...
### Final data products
  ...
  Final stage requires examination and validation of catalogues using [XID+SPIRE_CDFS-SWIRE_final_processing.ipynb](XID+SPIRE_CDFS-SWIRE_final_processing.ipynb).
