...
stilts ifmt=fits in=@cat_files out=dmu26_XID+PACS_ELAIS-S1_cat.fits
```
...
### Final data products
  Final stage requires examination and validation of catalogues using [XID+PACS_ELAIS-S1_final_processing](./XID+PACS_ELAIS-S1_final_processing).
