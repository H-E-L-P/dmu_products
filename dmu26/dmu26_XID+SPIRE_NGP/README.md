...
module load stilts
stilts tcat ifmt=fits in=@cat_files out=dmu26_XID+SPIRE_NGP_cat.fits
```
 
#### Computation 
 Details on computational cost of fitting NGP:
...
### Final data products
  Final stage requires examination and validation of catalogues using [XID+SPIRE_NGP_final_processing.ipynb](XID+SPIRE_NGP_final_processing.ipynb).
