...
for name in folders:
    ...
    print('stilts tcat ifmt=fits in=@cat_files out=dmu26_XID+SPIRE_HS82_cat_'+name[:-1]+'.fits')
    os.system('stilts tcat ifmt=fits in=@cat_files out=dmu26_XID+SPIRE_HS82_cat_'+name[:-1]+'.fits')
