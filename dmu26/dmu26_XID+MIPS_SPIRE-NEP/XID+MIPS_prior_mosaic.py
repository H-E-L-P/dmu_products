...
#dmu0_MOC=pymoc.MOC()
#dmu0_MOC.read('../../dmu0/dmu0_PanSTARRS1-3SS/data/')

holes=pymoc.MOC()
holes.read('../../dmu4/dmu4_sm_'+field+'/data/holes_SPIRE-NEP_irac1_O16_20190201_WARNING-MADE-WITH-Lockman-SWIRE-PARAMS.fits')
