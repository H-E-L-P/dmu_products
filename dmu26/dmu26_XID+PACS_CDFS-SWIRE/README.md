...
stilts ifmt=fits in=@cat_files out=dmu26_XID+PACS_CDFS-SWIRE_cat.fits
```
...
### Final data products
  ...
  (50th-16th percentile). The notebook [XID+PACS_CDFS_SWIRE_final_processing](./XID+PACS_CDFS_SWIRE_final_processing)
  adds the flag to each column where approriate. 
