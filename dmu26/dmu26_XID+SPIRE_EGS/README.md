...
module load stilts
stilts ifmt=fits in=@cat_files out=dmu26_XID+SPIRE_EGS_cat.fits
```
...
### Final data products
  Final stage requires examination and validation of catalogues using [XID+SPIRE_EGS_final_processing.ipynb](XID+SPIRE_EGS_final_processing.ipynb).
