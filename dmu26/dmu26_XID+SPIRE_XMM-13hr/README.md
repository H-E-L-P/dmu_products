...
module load stilts
stilts ifmt=fits in=@cat_files out=dmu26_XID+SPIRE_XMM-13hr_cat.fits
```
...
### Final data products
  Final stage requires examination and validation of catalogues using [XID+SPIRE_XMM-13hr_final_processing.ipynb](XID+SPIRE_XMM-13hr_final_processing.ipynb).
