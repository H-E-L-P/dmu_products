...
# stilts tapquery tapurl='https://herschel-vos.phys.sussex.ac.uk/__system__/tap/run/tap' adql="SELECT * FROM allwise.main WHERE field='ELAIS-N2'" maxrec=9999999 out=allwise_ELAIS-N2.fits

# filtering the WISE catalogue

stilts tcat in=AllWISE_20160512_ELAIS-N2.fits \
