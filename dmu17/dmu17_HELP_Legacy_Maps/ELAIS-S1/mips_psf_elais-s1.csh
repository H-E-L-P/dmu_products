...
#stilts tapquery tapurl='http://vohedamtest.lam.fr/__system__/tap/run/tap' adql="SELECT * FROM allwise.main WHERE field='ELAIS-S1'" maxrec=9999999 out=allwise_ELAIS-S1.fits
