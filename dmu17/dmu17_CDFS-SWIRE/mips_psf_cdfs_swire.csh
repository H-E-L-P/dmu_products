...
stilts tapquery tapurl='http://vohedamtest.lam.fr/__system__/tap/run/tap' adql="SELECT * FROM allwise.main WHERE field='CDFS-SWIRE'" maxrec=9999999 out=allwise_CDFS-SWIRE.fits
