...
An overview of the photo-z method as applied to the HELP datasets in outlined in [METHOD NOTEBOOK](Method) which provides additional documentation for the [eazy-pype](https://github.com/dunkenj/eazy-pype) package that implements the method. This notebook serves both as a reference for the HELP data products and a tutorial for reproducing the results and/or applying the method to new datasets.
