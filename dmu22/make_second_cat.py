...
for j in range(np.size(all_names)):
	...
	ff = fits.open(loc2+all_names[j]+'350_cat.fits')
	...
	ff = fits.open(loc2+all_names[j]+'500_cat.fits')
	...
	hdu = fits.BinTableHDU.from_columns(\
	     ...
	     fits.Column(name='F_BLIND_MF_SPIRE_250', array=S250_3, format ='F'),
	     fits.Column(name='FErr_BLIND_MF_SPIRE_250', array=E250_3, format ='F'),
	     fits.Column(name='F_BLIND_MF_SPIRE_350', array=S350_3, format ='F'),
	     fits.Column(name='FErr_BLIND_MF_SPIRE_350', array=E350_3, format ='F'),
	     fits.Column(name='F_BLIND_MF_SPIRE_500', array=S500_3, format ='F'),
	     fits.Column(name='FErr_BLIND_MF_SPIRE_500', array=E500_3, format ='F'),
	     fits.Column(name='r', array=r_3, format ='F'),
	     fits.Column(name='P', array=(ff[1].data)['P'], format ='F'),
	     fits.Column(name='RA_pix', array=(ff[1].data)['RA'], format ='F'), 
	     fits.Column(name='Dec_pix', array=(ff[1].data)['Dec'], format ='F'), 
	     fits.Column(name='F_BLIND_pix_SPIRE_500', array=(ff[1].data)['F_BLIND_pix_SPIRE_500'], format ='F'), 
	     fits.Column(name='FErr_BLIND_pix_SPIRE_500', array=(ff[1].data)['FErr_BLIND_pix_SPIRE_500'], format ='F') 
	     ])
