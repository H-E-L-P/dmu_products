...
defsysv,'!SMAP_DATA','~/GitHub/dmu_products/dmu19/dmu19_timelines/data/'
;; Now let's define the path to SPIRE source catalogs
defsysv,'!SMAP_CATS','~/GitHub/dmu_products/dmu19/dmu19_timelines/data/cats/'
;; and finally the path to SPIRE maps
defsysv,'!SMAP_MAPS','~/GitHub/dmu_products/dmu19/dmu19_timelines/data/maps/'
...
;; directory
defsysv,'!SMAP_PIPELINE_PATH','~/GitHub/smaproot/smap_pipeline/'
